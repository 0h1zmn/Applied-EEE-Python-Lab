...
*   **Active Balancing Algorithm:** Simulated a logic controller for 4S configuration to equalize voltage imbalances with proportionality gain tunable efficiency parameters ($\eta$).
